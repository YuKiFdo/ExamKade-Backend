export const CARRIER_ERROR_CODES: Record<string, string> = {
  ...
  'E1344': 'Sorry, your SMS sent to application could not be processed. Please check if you have sufficient balance and try again.',
  ...
  'E1316': 'Sorry, the application is temporarily unavailable. Please try again later.',
  ...
  'E1342': 'Sorry, Your phone number is blacklisted to use this application',
  'E1343': 'Non white listed mobile number accessing services of application',
  'E1318': 'Sorry, the application is temporarily unavailable. Please try again later.',
  'E1319': 'Sorry, the application is temporarily unavailable. Please try again later.',
  'E1340': 'Invalid request',
  ...
  'E1326': 'Sorry, your SMS sent to application could not be processed. Please check if you have sufficient balance and try again.',
  ...
  'E1331': 'Sorry, invalid/unauthorized source address. Please check the availability of default sender address or aliases for SMS-MT in application.',
  ...
  'E1334': 'Message length is too long.',
  'E1335': 'Message length is too long for advertisement messages.',
  'E1336': 'No matching service code found for the charging amount',
  'E1337': 'Subscriber authentication by charging gateway failed.',
  'E1351': 'User is already subscribed', // Mapped as per requirement and previous choice
  'E1356': 'User not registered',
  'E1357': 'Sorry, you are unauthorised to use the application.',
  ...
  'E1600': 'Sorry, the application is temporarily unavailable. Please try again later.',
  ...
  'E1853': 'Maximum number of OTP requests reached for this mobile number. Please wait a while before requesting again.',
